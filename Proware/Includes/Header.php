...
<nav class="navbar" role="navigation" aria-label="Main navigation">
    ...
    <div class="icons">
        ...
        <div class="icon notification-icon">
            <a href="javascript:void(0)" onclick="checkLoginStatus('notifications.php')" class="fas fa-bell"></a>
            <!-- Notification Popup -->
        ...
        <div class="icon">
            <a href="javascript:void(0)" onclick="checkLoginStatus('profile.php')" class="fas fa-user"></a>
        </div>
    </div>
</nav>
